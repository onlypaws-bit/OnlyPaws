...
async function stripeCancelAtPeriodEnd(opts: {
  secretKey: string;
  subscriptionId: string;
  stripeAccountId?: string | null;
}) {
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(
      JSON.stringify(
        {
          event: "cancel-fan-subscription:start",
          fanId,
          creator_id,
          subscriptionId,
          stripeAccountId,
    ...
    console.log(
      JSON.stringify(
        {
          event: "cancel-fan-subscription:retrieve",
          ok: retrieveRes.ok,
    ...
    const stripeRes = await stripeCancelAtPeriodEnd({
      secretKey: STRIPE_SECRET_KEY,
      subscriptionId,
      stripeAccountId,
    });
    ...
    console.log(
      JSON.stringify(
        {
          event: "cancel-fan-subscription:cancel",
          ok: stripeRes.ok,
    ...
    console.error("cancel-fan-subscription fatal", e);
